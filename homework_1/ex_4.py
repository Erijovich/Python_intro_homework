...
print('\nЭта программа по заданному номеру четверти, показывает диапазон возможных координат точек в этой четверти (x и y)\n')
...
print(f'\nВ {a} четверти диапазон возможных координат будет следующим: {text}\n')